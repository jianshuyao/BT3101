...
@app.callback(
    ...
    [State('user_login', 'value'),
     ...
     State('user', 'value')])
def update_table(submit_n_clicks, sort_by, data_dict, login, portfolio, type, product, direction, price, size, tenor, risk, timeframe, strategy, timestamp, user):
