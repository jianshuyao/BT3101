    ...
    return html.Div([                    
                html.Div([
                            ...
                            html.Div([
                                ...
                                className = 'row',
                                style = {'display': 'flex', 'flex-direction': 'row', 'margin-right':50}),
    ...
    children = [
        ...
        html.Div(
            dcc.Tabs(id = "tabs", 
                     ...
                     value = 'tab_2',
                     children = [
                         dcc.Tab(label='Individual Summary', 
                                 className = 'custom-tab', 
                                 selected_className="custom-tab--selected",
                                 value = 'tab_1',
                                 children = init_tab_1()),
                         dcc.Tab(label='Add Transaction',
                                 className = 'custom-tab', 
                                 selected_className="custom-tab--selected",
                                 value = 'tab_2',
                                 children = init_tab_2()),
...
### read file by interval & update user_login options
...
## check user_login value
#@app.callback(Output('user_login', 'value'),
#              [Input('user_login', 'options')],
#              [State('user_login', 'value')])
#def update_user_selection(options, user):
#    if user == None:
#        return options[0]
#    return user
